...
<body class="w-full flex flex-col">
    ...
    <!-- Hero Section: Start -->
    <section id="hero-section" class="relative flex items-center justify-center w-full h-screen">
    ...
    <!-- Book Section: Start -->
    <section id="book-section" class="w-full flex flex-col p-5 lg:py-15 lg:px-10">
        <div class="flex flex-row items-center">
            <h2 class="font-bold text-2xl lg:text-4xl">
                Buku Terpopuler
            </h2>
            <a href="{{ route('frontpage.books') }}" title="Klik untuk melihat lebih banyak buku"
