...
<body class="w-full flex flex-col">
    ...
    <!-- Search Filter: Start -->
    <form method="GET" action="{{ route('frontpage.books') }}"
        ...
        <div class="w-2/3 lg:w-75 flex flex-row rounded-lg border p-2 gap-2">
            ...
            <input type="search" name="keyword" placeholder="Search book here..."
                class="w-full text-base font-light outline-none" value="{{ request('keyword') }}" />
        </div>

        <select name="category_id" class="w-fit outline-none p-2 rounded-lg border">
    ...
    <!-- Book Section: Start -->
    <section id="book-section" class="w-full flex flex-col pt-5 pb-15 px-5 lg:px-10">
